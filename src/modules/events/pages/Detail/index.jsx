...
import EventItem from "@modules/events/components/EventItem/EventItem";
          ...
          <div className="container z-10 mx-auto">
            ...
            <div className="grid h-full grid-cols-2 content lg:gap-x-8 gap-y-4">
              <div className="flex flex-col justify-center col-span-2 text-white lg:pr-16 gap-y-4 lg:gap-y-10 md:col-span-1">
                <h1 className="text-5xl font-bold leading-snug text-white capitalize">
                  {data?.name || "Dream world wide in Jakata"}
                </h1>
                <h2 className="font-semibold text-white">By Saepul Rohman</h2>
                <div className="place">{data?.locationName}</div>
